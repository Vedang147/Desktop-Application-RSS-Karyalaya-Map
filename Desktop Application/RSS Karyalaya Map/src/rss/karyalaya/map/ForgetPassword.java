...
//        add(p1);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == search){
            try{
                String query = "select * from account1 where username = '"+tfusername.getText()+"'";
                Conn c = new Conn();
            ...
            try{
                String query = "select * from account1 where answer = '"+tfanswer.getText()+"' AND username = '"+tfusername.getText()+"'";
                Conn c = new Conn();
                ResultSet rs = c.s.executeQuery(query);
                while(rs.next()){
