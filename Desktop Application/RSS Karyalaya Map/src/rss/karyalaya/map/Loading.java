...
public class Loading extends JFrame implements Runnable {
    ...
    Loading(String username){
        ...
        JLabel text = new JLabel("RSS Karyalaya Map Application");
        text.setBounds(50, 20, 600, 40);
        text.setForeground(new Color(255, 165, 0, 255));
        //255, 165, 0, 255
        ...
        //loading.setForeground(new Color(255, 165, 0, 255));
        //255, 165, 0, 255
        ...
        //username.setForeground(new Color(255, 165, 0, 255));
        //255, 165, 0, 255
